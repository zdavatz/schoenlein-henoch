...
pub static DOKUMENT: &[Block] = &[
    ...
    Lead {
        ...
        blocks: &[
            ...
            P(&[
                B("Und am 5. September: Die Diagnose ist bestätigt."), T(" Das Eierstockkarzinom steht damit fest; worauf die Bestätigung beruht – Zellen oder Gewebe –, ist die Frage, die bleibt, weil nur das Gewebe Typ und Grad liefert. Vom selben Tag, vom Dispenser und vom Nachttisch abgelesen: "), B("Kalium"), T(" als Retardtablette und "), B("Magnesium"), T(" als Granulat sind neu dazugekommen, Pantoprazol und Movicol laufen, die Haut wird mit einer Harnstoff-Emulsion gepflegt – und am Infusionsständer hängt nicht mehr Kochsalz, sondern "), B("Ringer-Acetat"), T(". Kalium und Magnesium passen zum Kostaufbau, den dieses Blatt verlangt; bei einer GFR von 30 tragen beide aber eine Gegenanzeige an der Grenze, und die Infusionslösung nennt die Ödeme als ihre. Was daraus folgt, steht im Abschnitt «Der Stand vom 5. September» bei der Medikamentenliste. Und die Schmerzen: "), B("4 auf der Skala von 0 bis 10"), T(" – ein mittlerer Wert, unter laufendem Novalgin. Die Frage, ob dafür zusätzlich Opioid abgerufen wird, hat damit erstmals eine Zahl. Und der "), B("Blasenkatheter ist draussen"), T(" – ein Schritt zur Selbständigkeit und weniger Infektionsrisiko; die Urinmenge wird damit nicht mehr stündlich abgelesen, sondern muss gesammelt werden. Ein Blasenkatheter ist etwas anderes als die Harnleiter-Ableitungen vom 27. August; ob die noch liegen, ist eine eigene Frage."),
            ]),
        ],
    },
    ...
    P(&[B("Am 5. September gibt es dazu erstmals eine Zahl: Schmerzen 4 von 10."), T(" Ein mittlerer Wert unter der laufenden Infusion – nicht schmerzfrei, aber auch nicht der Bereich, in dem ein Opioid zwingend wird. Genau diese Zahl entscheidet die Frage des vorigen Absatzes: Solange sie unter der Novalgin-Infusion bei 4 bleibt, gibt es keinen Grund, den Darm mit einem Opioid weiter zu bremsen; steigt sie, ist die Frage neu. Deshalb gehört der Wert täglich aufs Verlaufsblatt – zusammen mit der Uhrzeit und dem, was davor gegeben wurde.")]),
