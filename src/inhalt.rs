...
pub static DOKUMENT: &[Block] = &[
    ...
    H3("Flohsamenschalen: warum die Antwort hier nein lautet"),
    P(&[B("Der Anlass ist ein Zeitungsartikel vom 2. September."), T(" Darin rät eine Chefärztin für Gastroenterologie, "), L("Flohsamenschalen und Heidelbeeren in den Joghurt zu rühren", "https://www.tagesanzeiger.ch/verdauung-flohsamenschalen-fuer-ein-gesundes-mikrobiom-211911241787"), T(" – gut für die Verdauung und das Mikrobiom. Die Packung dazu steht bei der Migros zwischen den Frühstücksflocken: "), L("Bio-Flohsamenschalen", "https://www.migros.ch/de/product/104236100000"), T(", "), N("110 g"), T(" für 3.50 Franken. Die Fachfrau ist einschlägig, und ihr Rat ist für seine Adressaten richtig – der Artikel sagt ausdrücklich, er sei das, was sie "), B("ihren Freundinnen und Freunden"), T(" raten würde. Für diese Patientin ist er es nicht, und das lässt sich mit Papier zeigen statt mit einer Meinung.")]),
    P(&[B("Derselbe Stoff, zwei Theken, zwei Auskünfte."), T(" Als Arzneimittel heisst Flohsamen in der Schweiz "), L("Agiolax mite", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933"), T(" – Swissmedic 42933, ATC A06AC01 – und trägt eine Fachinformation mit einer Liste von Gegenanzeigen. Als Lebensmittel steht derselbe Stoff im Regal «Flocken & Kleie». Die Produktseite nennt die Zutat («Flohsamenschalen»), die Nährwerte – "), N("88 g"), T(" Ballaststoffe je "), N("100 g"), T(", ein Esslöffel von "), N("4 g"), T(" also "), N("3,5 g"), T(" – und den Spurenhinweis auf Weizen, Hafer, Nüsse und Sesam. Sie nennt "), B("keine Gegenanzeige, keine Dosierung und keinen Flüssigkeitshinweis."), T(" Der Stoff ändert sich an der Ladentheke nicht. Was an Auskunft mitgeht, ändert sich vollständig – und das ist der ganze Unterschied zwischen dem Artikel und diesem Abschnitt.")]),
    P(&[B("Vier Sätze aus den "), L("Gegenanzeigen", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/contra_indications"), B(" treffen sie."), T(" Nicht sinngemäss, sondern wörtlich:")]),
    Liste(&[
        ...
        &[B("«Drohender oder bestehender Darmverschluss (Ileus), Megakolon-Syndrom, Verengungen (Stenosen) … innerhalb des Magen-Darm-Traktes.»"), T(" Der Gastroenterologe spricht von fehlender Peristaltik; eine der drei offenen Möglichkeiten ist die Peritonealkarzinose.")],
        &[B("«Patienten mit plötzlicher Änderung der Stuhlgewohnheit, die länger als 2 Wochen andauert.»"), T(" Trifft zu, seit dem Beginn dieser Krankengeschichte.")],
    ]),
    P(&[B("Dazu ein Warnhinweis, der bei ihr ausgerechnet an der Atemnot hängt."), T(" Mit jeder Einnahme müssen "), L("mindestens 150 ml Flüssigkeit getrunken werden", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/restrictions"), T("; ohne das quillt das Mittel zu schnell auf und kann Rachen oder Speiseröhre verlegen. Die Fachinformation schreibt die Folge aus: «Damit entsteht ein Risiko für "), B("Luftnot"), T(".» Der Artikel nennt "), N("200 ml"), T(" und stellt sie als Beigabe dar; die Fachinformation stellt sie als Bedingung dar. Sie trinkt wenig und erbricht immer wieder. Von den vier Gründen für ihre Atemnot ist am 2. September einer weggefallen – ein fünfter, rein mechanischer, wäre der vermeidbarste von allen.")]),
    P(&[B("Der Joghurt selbst ist dabei nicht das Problem."), T(" Dieselbe Fachinformation erlaubt ihn ausdrücklich: Das Granulat "), L("kann mit Joghurt vermischt eingenommen werden", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/usage"), T(" – und hängt den Satz an, den der Artikel weglässt: «Zusätzlich sollte reichlich Flüssigkeit getrunken werden.» Im selben Kapitel steht, dass aufrecht eingenommen wird und nicht unmittelbar vor dem Zubettgehen. Bei einer Patientin, die den Tag im Bett verbringt, ist auch das keine Selbstverständlichkeit, sondern eine Bedingung, die jemand einhalten muss.")]),
    ...
    P(&[B("Der dritte Einwand kommt vom Kostaufbau her."), T(" Ein Esslöffel liefert "), N("8 kcal"), T(". Er füllt den Magen und trägt zum Kalorienziel nichts bei – und der Magen ist bei ihr der Engpass. Dazu verzögert Flohsamen laut Fachinformation die Aufnahme von "), L("Mineralstoffen und Vitaminen", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/interactions"), T(", weshalb zu allen anderen Arzneimitteln eine halbe bis eine Stunde Abstand verlangt wird; ihr Kostaufbau besteht im Kern aus Thiamin, Phosphat, Kalium und Magnesium. Und die Konsistenz: Trockene Schalen wären das Gröbste, was auf diesem Tisch stünde. Das Birchermüesli kam am 2. September wieder heraus, der gekochte Haferbrei blieb drin. Das ist der Abschnitt «Poulet ging nicht», nur mit einer anderen Zutat.")]),
    P(&[B("Was dieses Blatt schon vorher sagte, und was daraus folgt."), T(" Ballaststoffe wirken über das Volumen und brauchen eine Peristaltik, die das Volumen weiterschiebt – der Absatz oben zum Spinat steht unverändert, und dort steht auch die Arbeit, in der das Weglassen der Ballaststoffe die Stuhlfrequenz erhöhte. In der Vergleichsstudie derselben Seite war Flohsamen zwar so wirksam wie Kiwi und Backpflaume, machte aber "), B("mehr Blähungen und Krämpfe"), T(" – und die Blähung ist das, was sie am meisten belastet. Die Rangfolge bleibt deshalb dieselbe wie oben: zuerst Kalium, Magnesium und TSH, dann die Frage nach dem Essen, und dann steht die Kiwi vorn. Flohsamen steht nicht vorn, sondern hinter vier Gegenanzeigen.")]),
    P(&[B("Zum Schluss die Regel, die grösser ist als dieser eine Beutel."), T(" Ein Rat aus dem Gesundheitsteil ist an Gesunde gerichtet. Das macht ihn nicht falsch, sondern unzuständig – und die Prüfung, die er nicht mitliefert, ist die Gegenanzeigenliste des entsprechenden Arzneimittels. Die gibt es zu fast allem, was als Hausmittel empfohlen wird, und sie ist frei zugänglich. Bei ihr steht sie viermal auf Rot. Diese Frage lohnt sich bei jedem gut gemeinten Vorschlag, bevor am Krankenbett ein Löffel im Joghurt landet.")]),
