...
pub static DOKUMENT: &[Block] = &[
    ...
    Liste(&[
        ...
        &[T("Woher kommt der weisse Schleim? Wurde bei der Darmspiegelung bis in den Krummdarm geschaut, wo der Befall am häufigsten ist – und wie sauber war der Darm nach vier bis fünf Wochen ohne Stuhlgang?")],
