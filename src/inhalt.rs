...
pub const STAND: &str =
    "Informationsblatt für die Patientin und ihre Angehörigen · Stand 2. September 2026 · zum Mitnehmen zum Arzttermin";
...
pub static DOKUMENT: &[Block] = &[
    ...
    P(&[T("Am 2. September kommen zwei Meldungen, und sie gehören zusammen: Es seien «ein paar pathologische Zellen» gefunden worden – und sie geht heute zum Gynäkologen. Die zweite ist mit einiger Wahrscheinlichkeit die Folge der ersten. Dieser Abschnitt sagt, was daraus folgt, was daraus ausdrücklich nicht folgt und welche eine Rückfrage über alles Weitere entscheidet.")]),
    ...
    H3("Flohsamenschalen: gut – nur nicht für sie"),
    P(&[B("Der Anlass ist ein Zeitungsartikel vom 2. September."), T(" Darin rät eine Chefärztin für Gastroenterologie, "), L("Flohsamenschalen und Heidelbeeren in den Joghurt zu rühren", "https://www.tagesanzeiger.ch/verdauung-flohsamenschalen-fuer-ein-gesundes-mikrobiom-211911241787"), T(" – gut für die Verdauung und das Mikrobiom. Die Packung dazu steht bei der Migros zwischen den Frühstücksflocken: "), L("Bio-Flohsamenschalen", "https://www.migros.ch/de/product/104236100000"), T(", "), N("110 g"), T(" für 3.50 Franken. Der Rat ist gut. Dieser Abschnitt fängt deshalb mit dem an, was für Flohsamenschalen spricht – und erst danach kommt, warum die Rechnung ausgerechnet bei ihr kippt.")]),
    P(&[B("Was für sie spricht, und es ist einiges."), T(" Bei chronischer Verstopfung wirken sie: In der Vergleichsstudie weiter oben erhöhten "), N("12 g"), T(" Flohsamen die vollständigen spontanen Stuhlgänge, genauso gut wie zwei Kiwis oder Backpflaumen. Beim Cholesterin ist die Beweislage so gut, dass eine Behörde eine Gesundheitsaussage erlaubt: Die amerikanische Lebensmittelverordnung gibt für lösliche Faser aus Flohsamenschale den Anspruch auf ein "), L("geringeres Risiko für koronare Herzkrankheit", "https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-101/subpart-E/section-101.81"), T(" frei. Und der übliche Einwand gegen Ballaststoffe – sie blähen – trifft ausgerechnet auf diesen nicht: In einer Studie an "), N("19 Reizdarm-Kranken"), T(" wurde das Darmgas im "), L("Kernspin gemessen", "https://pubmed.ncbi.nlm.nih.gov/34353864/"), T("; Inulin steigerte die Gasbildung, Flohsamen senkte sie. Der Grund liegt in der Chemie: Der gelbildende Anteil macht rund "), L("55 Prozent der Schale", "https://pubmed.ncbi.nlm.nih.gov/12749348/"), T(" aus und wird schlecht vergoren – er quillt, statt zu gären. Dazu regulieren Flohsamenschalen in beide Richtungen: Zu Flüssiges wird fester, zu Festes weicher. Das kann kaum ein anderes Mittel, und es kostet fast nichts.")]),
    P(&[B("Was im Beutel ist, ist nicht dasselbe wie in der Apotheke – und zwar in die schärfere Richtung."), T(" Das zugelassene Schweizer Flohsamen-Präparat "), L("Agiolax mite", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933"), T(" (Swissmedic 42933, ATC A06AC01) enthält je Teelöffel "), L("3,25 g ganzen Samen und nur 0,11 g Schale", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/galenic_form"), T(" – also rund drei Prozent Schale. Der Migros-Beutel ist reine Schale, "), N("88 g"), T(" Ballaststoff je "), N("100 g"), T(". Derselbe Rohstoff, aber nicht dieselbe Zubereitung – und die Schale ist die konzentriertere, stärker gelbildende von beiden. Wer die Fachinformation heranzieht, überträgt deshalb kein fremdes Etikett. Er nimmt die einzige kompakte, behördlich geprüfte Liste der Umstände, unter denen dieses Material gefährlich wird.")]),
    P(&[B("Denn eine Lebensmittelbehörde schreibt dazu dasselbe."), T(" Das ist der Punkt, an dem das Argument ohne jedes Arzneimittel auskommt. Die amerikanische Vorschrift über "), L("Warnhinweise auf Lebensmitteln", "https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-101/subpart-A/section-101.17"), T(" führt einen eigenen Absatz «Foods containing psyllium husk», und er gilt ausdrücklich für trockene oder unvollständig gequollene Flohsamenschale. Vorgeschrieben ist auf der "), B("Lebensmittelpackung"), T(": Dieses Lebensmittel sei mit mindestens einem vollen Glas Flüssigkeit zu essen; ohne genügend Flüssigkeit könne es zum Ersticken führen; und: "), B("«Essen Sie dieses Produkt nicht, wenn Sie Schluckbeschwerden haben.»"), T(" Die Ausnahme beweist die Sache vollends – befreit ist ein Lebensmittel nur dann, wenn es mit Flüssigkeit "), B("keine zähe, klebende Masse"), T(" bildet. Reine Schale ist der Musterfall eines Lebensmittels, das genau das tut. Die Einschränkung gehört dazu: Das ist amerikanisches Recht, und ein entsprechend zwingender Warnhinweis für Lebensmittel in der Schweiz ist nicht bekannt. Es bleibt das Urteil einer Lebensmittelbehörde über dieses Material als Lebensmittel.")]),
    P(&[B("Und die berichteten Schadensfälle sind Schalenfälle."), T(" Das gehört dazu, weil sonst der Verdacht bliebe, hier werde von einem Medikament auf ein Lebensmittel geschlossen. Es ist umgekehrt:")]),
    Liste(&[
        &[B("Betagter Heimbewohner, Dünndarmverschluss, Operation."), T(" Die Arbeit heisst "), L("«Bulk laxative ileus»", "https://pubmed.ncbi.nlm.nih.gov/7365186/"), T(". Der unmittelbare Auslöser war wahrscheinlich ein Karzinom des aufsteigenden Dickdarms – dahinter staute sich das Füllmittel im ganzen Dünndarm und dickte ein. Das ist der Fall, der ihrer Lage am nächsten kommt: alt, Füllmittel, ein nicht erkanntes Hindernis.")],
        &[B("48-jährige Frau, "), N("1,5 Teelöffel"), B(" Flohsamenschale täglich mit wenig Wasser."), T(" Bezoar im Leerdarm, "), L("Dünndarmverschluss, Laparoskopie", "https://pubmed.ncbi.nlm.nih.gov/29085697/"), T(". Als Risikogruppe nennt die Arbeit ausdrücklich Magenentleerungsstörungen. Der Zeitungsartikel empfiehlt ein bis zwei Teelöffel – die berichtete Schadensmenge liegt also "), B("innerhalb"), T(" der empfohlenen, sobald die Flüssigkeit fehlt.")],
        &[B("21-jähriger Mann, ohne Vorerkrankung."), T(" Wegen Verstopfung auf Flohsamenschalen entlassen, zwei Tage später mit zunehmender Blähung und ohne Stuhl zurück: "), L("unvollständiger Darmverschluss", "https://pubmed.ncbi.nlm.nih.gov/30321826/"), T(", weil zu wenig getrunken wurde. Wenn das einem Gesunden in zwei Tagen zustösst, ist der Abstand zum Schaden auch bei Gesunden nicht gross.")],
        &[B("76-jähriger Mann mit Parkinson."), T(" Wenige Stunden nach Flohsamenschalen-Pulver ein akuter "), L("Verschluss der Speiseröhre", "https://pubmed.ncbi.nlm.nih.gov/35321163/"), T(": ein Bezoar von 2,0 mal 2,5 cm am Mageneingang, endoskopisch entfernt. Die Autoren führen es auf die gestörte Speiseröhrenmotorik zurück – eine langsame Passage lässt das Gel dort quellen, wo es noch liegt.")],
        &[B("Und der seltenste Fall, weil er den Satz «es ist ja nur ein Lebensmittel» beantwortet."), T(" Eine 42-jährige Frau starb an einer "), L("Anaphylaxie nach einem Flohsamenprodukt", "https://pubmed.ncbi.nlm.nih.gov/14700444/"), T(". Sehr selten – aber ein Lebensmittel zu sein schützt vor nichts.")],
    ]),
    P(&[B("Warum der Nutzen bei ihr wegfällt, steht in der Fachinformation selbst."), T(" Sie beschreibt den Wirkweg: Die Quellstoffe vergrössern das Darmvolumen und beschleunigen die Passage "), L("reflektorisch über einen Dehnungsreiz", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/effects"), T(". Die Kette lautet also: Wasser binden, Volumen, Dehnung der Darmwand, Reflex, Peristaltik, Transport. Alles bis zum vorletzten Glied funktioniert bei ihr. Das letzte ist genau das, von dem der Gastroenterologe gesagt hat, es fehle – und dass der Stuhlgang seit einer Woche wieder geht, heisst, dass etwas durchkommt, nicht dass geklärt wäre, warum er stand. Fairerweise: Movicol und Duphalac nennen in ihren Fachinformationen ebenfalls Volumen und Peristaltik. Der Unterschied ist enger, als er zuerst aussieht, aber es ist der, den die Fälle oben belegen – Macrogol bindet Wasser, das flüssig bleibt; die Schale bringt einen Feststoff, der geliert und eindicken kann. Bezoar-Berichte gibt es zur Schale, nicht zu Macrogol.")]),
    P(&[B("Die Gegenanzeigen sind deshalb kein fremdes Etikett, sondern die Checkliste."), T(" Vier von ihnen treffen sie, und zwar "), L("wörtlich", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/contra_indications"), T(":")]),
    Liste(&[
        &[B("«Nicht diagnostizierte Rektalblutungen und ausbleibender Stuhlgang nach Anwendung eines Abführmittels.»"), T(" Beide Hälften waren in den letzten zwei Wochen wahr, und die Blutungsquelle ist bis heute nicht gesichert – die Darmspiegelung war schlecht vorbereitet.")],
        &[B("«Abdominale Schmerzen unbekannter Ursache.»"), T(" Die Beurteilung im Bericht vom 30. August lautet wörtlich «unklares Krankheitsbild», und der Bauchschmerz ist ihre Hauptbeschwerde.")],
        &[B("«Drohender oder bestehender Darmverschluss (Ileus), Megakolon-Syndrom, Verengungen (Stenosen) … innerhalb des Magen-Darm-Traktes.»"), T(" Der Gastroenterologe spricht von fehlender Peristaltik; eine der drei offenen Möglichkeiten ist die Peritonealkarzinose. Das ist der Satz mit dem meisten Gewicht, weil er der Fall von Berman ist.")],
        &[B("«Patienten mit plötzlicher Änderung der Stuhlgewohnheit, die länger als 2 Wochen andauert.»"), T(" Trifft zu – wiegt aber am wenigsten: Das ist eine Regel für die Selbstmedikation, und sie soll Leute zum Arzt schicken. Sie ist beim Arzt.")],
    ]),
    P(&[B("Der Warnhinweis, der bei ihr ausgerechnet an der Atemnot hängt."), T(" Mit jeder Einnahme müssen "), L("mindestens 150 ml Flüssigkeit getrunken werden", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/restrictions"), T("; ohne das quillt das Mittel zu schnell auf und kann Rachen oder Speiseröhre verlegen. Die Folge steht ausgeschrieben da: «Damit entsteht ein Risiko für "), B("Luftnot"), T(".» Unter den unerwünschten Wirkungen stehen dieselben drei Wörter noch einmal – "), L("Obstruktion, Dysphagie, Koprostase", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/unwanted_effects"), T(", ausdrücklich für den Fall zu geringer Flüssigkeitsmenge. Sie trinkt wenig und erbricht immer wieder. Von den vier Gründen für ihre Atemnot ist am 2. September einer weggefallen – ein fünfter, rein mechanischer, wäre der vermeidbarste von allen.")]),
    P(&[B("Dem Joghurt gehört dabei etwas zugestanden."), T(" Er entschärft wirklich einen Teil: Ein Becher ist überwiegend Wasser, und die Schale ist gequollen, bevor sie geschluckt wird – das ist die sichere Zubereitungsform, und der Artikel empfiehlt genau sie. Dieselbe Fachinformation erlaubt ihn ausdrücklich: Das Granulat "), L("kann mit Joghurt vermischt eingenommen werden", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/usage"), T(" – und hängt den Satz an, den der Artikel weglässt: «Zusätzlich sollte reichlich Flüssigkeit getrunken werden.» Im selben Kapitel steht, dass aufrecht eingenommen wird und nicht unmittelbar vor dem Zubettgehen; bei einer Patientin, die den Tag im Bett verbringt, ist auch das eine Bedingung, die jemand einhalten muss. "), B("Was der Joghurt nicht entschärft, ist das, was danach kommt:"), T(" Das Gel landet in einem Magen, der schlecht entleert, und in einem Darm, bei dem niemand geklärt hat, warum der Transport gestanden hat.")]),
    P(&[B("Und ein Satz, der aus einer Vorsichtsmassnahme ein Verbot macht."), T(" Mittel mit hemmendem Einfluss auf die Darmperistaltik – Opiate ausdrücklich genannt – dürfen wegen des Risikos eines Darmverschlusses "), L("nicht gleichzeitig verabreicht werden", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/restrictions"), T(". Auf ihrer Reserveliste stehen zwei Opioide. Solange keines abgerufen wird, ist das eine Möglichkeit; sobald eines gegeben wird, ist es genau die Kombination, die die Fachinformation ausschliesst. Der Abschnitt «Interaktionscheck» sagt dasselbe von der anderen Seite her: Opioide verstopfen. Im selben Kapitel steht ausserdem der Satz, der ihre Gruppe beim Namen nennt: «Die Behandlung von geschwächten älteren Patienten muss unter ärztlicher Kontrolle erfolgen.»")]),
    P(&[B("Der Einwand vom Kostaufbau her."), T(" Ein Esslöffel liefert "), N("8 kcal"), T(". Er füllt den Magen und trägt zum Kalorienziel nichts bei – und der Magen ist bei ihr der Engpass. Dazu verzögert Flohsamen laut Fachinformation die Aufnahme von "), L("Mineralstoffen und Vitaminen", "https://ch.oddb.org/de/gcc/fachinfo/reg/42933/chapter/interactions"), T(", weshalb zu allen anderen Arzneimitteln eine halbe bis eine Stunde Abstand verlangt wird; ihr Kostaufbau besteht im Kern aus Thiamin, Phosphat, Kalium und Magnesium. Und die Konsistenz: Trockene Schalen wären das Gröbste, was auf diesem Tisch stünde. Das Birchermüesli kam am 2. September wieder heraus, der gekochte Haferbrei blieb drin. Das ist der Abschnitt «Poulet ging nicht», nur mit einer anderen Zutat.")]),
    P(&[B("Wie gross das Risiko ist – ehrlich."), T(" Millionen Menschen nehmen das täglich ohne jeden Schaden. Die Fälle oben sind Einzelfallberichte, die schwächste Form von Beleg, und das absolute Risiko ist auch bei ihr klein. Der Satz dieses Abschnitts lautet deshalb nicht «gefährlich», sondern: "), B("Es würde ihr im Moment nichts bringen – und für nichts lohnt sich auch ein kleines Risiko nicht."), T(" Beides ändert sich zugleich. Der Nutzen fällt weg, weil die Wirkkette ein Glied braucht, das bei ihr fehlt; das Risiko steigt, weil sich bei ihr genau die Umstände häufen, unter denen die Fälle passiert sind. Nicht der Stoff hat sich geändert, sondern der Mensch, der ihn nehmen soll.")]),
    P(&[B("Wann die Antwort ja hiesse."), T(" Das ist keine höfliche Geste, sondern eine Liste: wenn geklärt ist, warum die Passage gestanden hat, und sie sicher trägt; wenn der Bauch abgeklärt ist und keine Enge im Spiel; wenn sie zuverlässig trinkt und nicht mehr erbricht; wenn kein Opioid läuft. Dann sind Flohsamenschalen wieder ein gutes, billiges und gut belegtes Mittel – und selbst dann steht die Kiwi wegen ihrer Verträglichkeit knapp davor. Der Beutel ist also nicht umsonst gekauft. Er ist im Moment für die Falsche im Haus.")]),
    P(&[B("Zum Schluss die Regel, die grösser ist als dieser eine Beutel."), T(" Ein Rat aus dem Gesundheitsteil ist an Gesunde gerichtet. Das macht ihn nicht falsch, sondern unzuständig – und die Prüfung, die er nicht mitliefert, ist die Gegenanzeigenliste des Stoffes. Die gibt es zu fast allem, was als Hausmittel empfohlen wird, und sie ist frei zugänglich. Sie lohnt sich bei jedem gut gemeinten Vorschlag, bevor am Krankenbett ein Löffel im Joghurt landet.")]),
    Klein(&[T("Eine Nebenrechnung, weil die Packung die Zahlen dazu liefert: Der Artikel schreibt, Joghurt mit Flohsamenschalen und einer Handvoll Heidelbeeren decke «etwa die Hälfte» des Tagesbedarfs von "), N("30 g"), T(" Ballaststoffen. "), N("5 g"), T(" Schalen zu 88 Prozent sind "), N("4,4 g"), T("; eine Handvoll Heidelbeeren, "), N("80 g"), T(" zu den vom Artikel selbst genannten "), N("4,9 g"), T(" je "), N("100 g"), T(", sind "), N("3,9 g"), T("; der Joghurt trägt nichts bei. Zusammen gut "), N("8 g"), T(", also gut ein Viertel und nicht die Hälfte. An der Sache ändert das nichts. Es ist trotzdem der Grund, Zahlen nachzurechnen, bevor man ihnen folgt.")]),
    ...
    P(&[T("Diese Liste ist mit dem Zwischenbericht neu geordnet worden. Drei der bisherigen acht Fragen sind darin beantwortet – der Harnleiter ist entlastet, ein Blutzerfall ist ausgeschlossen, der frühere Schub ist datiert. Dafür sind andere dazugekommen, und die erste von ihnen war vorher gar nicht auf dem Blatt. Am 2. September ist die zweite hinzugetreten, und sie ist die einzige mit einer Frist von Stunden: Untersuchte Flüssigkeit lässt sich aufheben, ununtersuchte wird verworfen. Wenn im Zimmer nur fünf Minuten bleiben, sind es diese zehn.")]),
    Liste(&[
        &[B("1. Welche Kategorie steht im zytologischen Befund – und ist PAX8 gelaufen?"), T(" Seit dem 2. September gibt es dafür zwei Proben aus zwei Körperhöhlen, beurteilt nach demselben fünfstufigen System. Am 2. September heisst es, es seien «ein paar pathologische Zellen» gefunden worden. Die abgestufte Sprache der Zytologie unterscheidet «Atypie unklarer Bedeutung» von «verdächtig» und «bösartig», und das Risiko dahinter reicht von 50,8 über 91,3 bis 98,2 Prozent – zwischen der ersten und der zweiten Stufe liegt der Unterschied zwischen offen und beinahe entschieden. Dazu: Wurde ein Zellblock angelegt, und ist PAX8 mitbestimmt worden? Er zeigt die Herkunft aus dem Müller-System und braucht keinen neuen Eingriff. Und weiterhin fehlt die Zahl, die im Bericht fehlte: das "), B("Albumin im Blut"), T(" vom selben Tag, ohne die sich der Serum-Aszites-Albumin-Gradient nicht bilden lässt.")],
    ...
    Liste(&[
        ...
        &[T("Werden die 1500 ml Kochsalzlösung am Tag noch gebraucht, jetzt wo sie trinkt und sechs Kilo zugelegt hat?")],
...
pub static QUELLEN: &[(&str, Verweis)] = &[
    ...
    ("21 CFR 101.17(f): Food labeling warning, notice, and safe handling statements – Foods containing psyllium husk",
     Verweis { text: "ecfr.gov – 21 CFR 101.17", url: "https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-101/subpart-A/section-101.17" }),
    ("21 CFR 101.81: Health claims – Soluble fiber from certain foods and risk of coronary heart disease",
     Verweis { text: "ecfr.gov – 21 CFR 101.81", url: "https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-101/subpart-E/section-101.81" }),
    ("Gunn D et al.: Psyllium reduces inulin-induced colonic gas production in IBS: MRI and in vitro fermentation studies. Gut 2022; 71: 919-27. PMID 34353864",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/34353864/", url: "https://pubmed.ncbi.nlm.nih.gov/34353864/" }),
    ("Marlett JA, Fischer MH: The active fraction of psyllium seed husk. Proc Nutr Soc 2003; 62: 207-9. PMID 12749348",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/12749348/", url: "https://pubmed.ncbi.nlm.nih.gov/12749348/" }),
    ("Berman JI, Schultz MJ: Bulk laxative ileus. J Am Geriatr Soc 1980; 28: 224-6. PMID 7365186",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/7365186/", url: "https://pubmed.ncbi.nlm.nih.gov/7365186/" }),
    ("Abou Azar S et al.: Small Bowel Obstruction Secondary to a Metamucil Bezoar. Case Rep Surg 2017; 2702896. PMID 29085697",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/29085697/", url: "https://pubmed.ncbi.nlm.nih.gov/29085697/" }),
    ("Hefny AF et al.: Intestinal obstruction caused by a laxative drug (Psyllium): A case report and review of the literature. Int J Surg Case Rep 2018; 52: 59-62. PMID 30321826",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/30321826/", url: "https://pubmed.ncbi.nlm.nih.gov/30321826/" }),
    ("Shin S et al.: Acute esophageal obstruction after ingestion of psyllium seed husk powder: A case report. World J Clin Cases 2022; 10: 2336-40. PMID 35321163",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/35321163/", url: "https://pubmed.ncbi.nlm.nih.gov/35321163/" }),
    ("Khalili B et al.: Psyllium-associated anaphylaxis and death: a case report and review of the literature. Ann Allergy Asthma Immunol 2003; 91: 579-84. PMID 14700444",
     Verweis { text: "https://pubmed.ncbi.nlm.nih.gov/14700444/", url: "https://pubmed.ncbi.nlm.nih.gov/14700444/" }),
