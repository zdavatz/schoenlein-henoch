...
//
// Verlinkt wird das einzelne Kapitel, nicht die ganze Fachinformation:
...
pub static QUELLEN: &[(&str, Verweis)] = &[
    ...
    ("Novalgin, unerwünschte Wirkungen: Blutbild, Magen-Darm-Blutungen, Nierenversagen, Rotfärbung des Harns",
    ...
    ("Novalgin, Interaktionen: Aspirin, Methotrexat, gestörte Messung des Kreatinins",
    ...
    ("Novalgin, Kontraindikationen: eingeschränkte Knochenmarksfunktion, frühere Agranulozytose",
    ...
    ("Novalgin, Dosierung: ältere Patienten, Nieren- und Leberfunktion",
    ...
    ("Novalgin-F Tabletten (Metamizol), Zusammensetzung",
     Verweis { text: "https://ch.oddb.org/de/gcc/fachinfo/reg/16951/chapter/composition", url: "https://ch.oddb.org/de/gcc/fachinfo/reg/16951/chapter/composition" }),
    ("Movicol, Movicol neutral, Movicol Chocolat, Zusammensetzung: Aroma und Süssstoff",
    ...
    ("Movicol, Kontraindikationen: Ileus, intestinale Obstruktion, Perforation",
    ...
    ("Movicol, Warnhinweise: die zubereitete Lösung ersetzt die Flüssigkeitszufuhr nicht",
    ...
    ("Movicol, Dosierung: über 65 Jahre genügt ein Beutel täglich",
    ...
    ("Movicol, sonstige Hinweise: Haltbarkeit der zubereiteten Lösung, 24 gegen 6 Stunden",
    ...
    ("Laxipeg banane und Laxipeg aromafrei, Zusammensetzung: Hilfsstoffe keine",
    ...
    ("Transipeg und Transipeg forte, Zusammensetzung: Aspartam und Acesulfam-Kalium",
    ...
    ("Duphalac, Zusammensetzung: Hilfsstoffe keine",
    ...
    ("Duphalac, Warnhinweise: unklare Bauchschmerzen vor Behandlungsbeginn abklären",
    ...
    ("Duphalac, Kontraindikationen: gastrointestinale Obstruktion und Perforation",
    ...
    ("Duphalac, unerwünschte Wirkungen: Durchfall 13,1 Prozent, Flatulenz, Bauchschmerzen",
    ...
    ("Duphalac, Interaktionen: Kaliumverlust unter Kortikosteroiden, Opiate schwächen die Wirkung ab",
    ...
    ("Duphalac, Dosierung: 1,5 bis 2 Liter Flüssigkeit am Tag",
    ...
    ("Duphalac, Eigenschaften: Vergärung der Lactulose im Dickdarm",
    ...
    ("Gatinar (Lactulose), Zusammensetzung",
    ...
    ("Rudolac (Lactulose), Zusammensetzung",
    ...
    ("Importal (Lactitol), Zusammensetzung",
    ...
    ("Moviprep, Zusammensetzung: Aspartam, Acesulfam-Kalium, Zitronenaroma",
    ...
    ("Picoprep, Zusammensetzung: Saccharin-Natrium, Orangenaroma",
