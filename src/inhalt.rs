...
pub static DOKUMENT: &[Block] = &[
    ...
    P(&[B("Und die Behandlungsfrage kippt."), T(" Die letzte der neun Fragen weiter unten lautete: Wird die Behandlung der Vaskulitis neu beurteilt, sobald die Zytologie da ist? Sie ist damit keine Vorsichtsfrage mehr, sondern die Frage des Tages. Ein Kortikoid oder eine stärkere Immunsuppression sind bei einer Vaskulitis das eine und bei einer Bösartigkeit im Bauchfell etwas ganz anderes.")]),
    ...
    Liste(&[
        ...
        &[B("6. Wie hat sich das Kreatinin seit der Entlastung entwickelt, und wie viel Urin kommt?"), T(" Die Ableitungen liegen seit dem 27. August; wenn der Stau die Ursache war, muss das Kreatinin fallen. Am 30. August bestand trotz Rehydrierung eine Oligurie. Bei einem Trockengewicht von "), N("58 kg"), T(" ist die Schwelle "), N("29 ml"), T(" Urin je Stunde – darunter ist es für sich allein ein akutes Nierenversagen. Und dazu die Zahl, die alles davon einordnet: "), B("die tägliche Gewichtskurve"), T(". Sie liegt bei "), N("66 kg"), T(" gegenüber sonst "), N("58 kg"), T("; das sind acht Liter, und es sind sechs seit dem Eintritt.")],
